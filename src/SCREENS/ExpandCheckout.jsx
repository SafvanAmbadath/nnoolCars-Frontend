...
import scan from "../COMPONENTS/images/images (3).jpeg"
import car from "../COMPONENTS/images/images (3).jpeg"
import { useLocation, useNavigate } from "react-router-dom";
import GooglePayButton from "@google-pay/button-react";
import { PayPalScriptProvider, PayPalButtons } from "@paypal/react-paypal-js";
import { expandTime } from "../API/SERVICES/bookingCar";
...
function ExpandCheckout() {
  ...
  const complitePayment = async (upi) => {
    const data = {
      amount: state.amount,
      paymentMethod: upi,
      expandHoures: state.slider,
      orderId,
      endDate,
    };

    const res = await expandTime(data);
                ...
                <div className="h-72 w-full  border-b-2 justify-center">
                  ...
                  <div className="justify-center">
                    <div className="flex">
                      ...
                      <div className="w-4/12 p-3  mt-4 flex">
                        <div>
                          <div className="h-20 w-0 -mt-6 border-2"></div>
                          <h1 className="text-xl -ml-2">or</h1>
                          <div className="h-20 w-0  border-2"></div>
                        </div>
                        <div className="">
                          <h1 className="text-lg ml-2">Scan QR code</h1>
                          <img
                            src={scan}
                            alt=""
                            className="w-28 h-28 ml-3 opacity-50"
                          />
                        </div>
                      </div>
                    </div>
